import { ITEM_IMG_CDN } from "../../constants.js";
import { addItem, getTotalAmount, removeItem } from "../utils/cartSlice";
import { useDispatch, useSelector } from "react-redux";
import { useState } from "react";

const MenuItem = ({ item }) => {
    console.log("jkdodn",item);
  ...
  const handleAddItem = (item) => {
    ...
    dispatch(getTotalAmount());
     // redux send action object to store {payload : item}
